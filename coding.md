...
- **DRY (Don't Repeat Yourself):** Every piece of knowledge should have a single, unambiguous representation. Extract duplicated logic into shared functions or modules
